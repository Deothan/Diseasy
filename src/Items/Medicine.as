package Items
{
	...
	public class Medicine extends Sprite implements Entity, Item{
		...
		private function Start():void{
			medicineImage = new Image(assetManager.getTexture("medicine"));
		...
		public function triggerEffect():void{
			Destroy();
			View.GetInstance().GetInfant().setHealth(10);
